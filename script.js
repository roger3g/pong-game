...
function inicializa(){
	...
	vjogador=document.getElementById("divJogador");
	vcpu=document.getElementById("divCPU");
	vbola=document.getElementById("divBola");
	vPaineltxtPontos=document.getElementById("textPontos");
